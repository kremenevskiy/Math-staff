...
public:
    ...
    QPlainTextEdit *PrimeNumsText;
    QLabel *label_2;
    QPushButton *findNumsButton;
    QWidget *widget;
...
""));
        ...
        PrimeNumsText = new QPlainTextEdit(centralwidget);
        PrimeNumsText->setObjectName(QString::fromUtf8("PrimeNumsText"));
        PrimeNumsText->setGeometry(QRect(20, 50, 281, 321));
        PrimeNumsText->setReadOnly(true);
        ...
        findNumsButton = new QPushButton(centralwidget);
        findNumsButton->setObjectName(QString::fromUtf8("findNumsButton"));
        findNumsButton->setGeometry(QRect(320, 90, 191, 51));
        widget = new QWidget(centralwidget);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(320, 50, 191, 28));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_2->setText(QCoreApplication::translate("MainWindow", "Prime Numbers", nullptr));
        findNumsButton->setText(QCoreApplication::translate("MainWindow", "RUN | FIND all PRIME", nullptr));
        label->setText(QCoreApplication::translate("MainWindow", "Max N :", nullptr));
    } // retranslateUi
